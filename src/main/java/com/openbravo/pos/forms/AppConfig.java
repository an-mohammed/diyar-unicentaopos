...
public class AppConfig implements AppProperties {
  ...
  public static AppConfig getInstance() {
    ...
    if (m_instance == null) {
    	System.out.println("user.home----->"+System.getProperty("user.home")+","+ AppLocal.APP_ID + ".properties");
...
// secondary DB        
    ...
    m_propsconfig.setProperty("tkt.header1", "Diyar oPOS");
    m_propsconfig.setProperty("tkt.header2", "Diyar Touch Friendly Point Of Sale");
    
    
    m_propsconfig.setProperty("tkt.header3", "Copyright (c) 2009-2018 Diyar");
    ...
    m_propsconfig.setProperty("tkt.footer2", "Thank you for visiting store");
